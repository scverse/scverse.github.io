...
[[sections]]
	...
	datastructures_post = "In addition to these packages, we define standard on how to represent certain data types in these data structures. For now, this is available for [Adaptive Immune Receptor Repertoire (AIRR) data](https://scirpy.scverse.org/en/latest/data-structure.html#storing-airr-rearrangement-data-in-anndata). Representations for other data types (e.g. scATAC-seq) will follow."
